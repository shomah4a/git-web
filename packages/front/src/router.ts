/**
 * Vue Router 設定 (ADR 0022, ADR 0023, ADR 0028, ADR 0038, ADR 0046, ADR 0047)。
 *
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/wt/blob',
      name: 'worktree-blob',
      component: () => import('./components/WorktreeBlobView.vue'),
    },
    {
      path: '/commits',
      name: 'commits',
      component: () => import('./components/CommitsView.vue'),
    },
    {
      path: '/graph',
      name: 'graph',
